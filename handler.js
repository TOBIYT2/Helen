...
global.db.data.users[m.sender].spam = new Date * 1
            ...
            continue
             ...
             m.isCommand = true
                ...
                // 🔒 BLOQUEO POR MODO SOLO ADMIN
if (global.versionadmin) {
  if (!isAdmin && !isOwner && !isROwner) {
    console.log(`[VERSIONADMIN] ${m.sender} bloqueado por modo solo admin`);
    return this.reply(m.chat, '🚫 *Solo los admins pueden usar comandos en este momento.*', m);
  }
}
...
global.dfail = async (type, m, conn) => {
  const mensajes = {
    ...
    unreg: `「💙」 *No te encuentras registrado, regístrate para usar esta función*\n\n*/rem nombre.edad*\n\n*Ejemplo:* */rem Rem.18*\n\n😼 https://whatsapp.com/channel/0029VapASNA9cDDT9yfhXr30`,
    restrict: '「💙」 *Esta característica está desactivada.*\n\n😼 https://whatsapp.com/channel/0029VapASNA9cDDT9yfhXr30'
  }

  const msg = mensajes[type]
  const img = 'https://files.catbox.moe/dojevc.jpg'
